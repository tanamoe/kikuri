        ...
        <ul class="flex gap-3">
          <li>
            <NuxtLink
              ...
              target="_blank"
              class="transition-colors duration-100 ease-linear hover:text-[#1877f2]"
            >
              <svg
          ...
          <li>
            <NuxtLink
              to="https://twitter.com/mangaglhf/"
              target="_blank"
              class="transition-colors duration-100 ease-linear hover:text-[#1da1f2]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <li>
            <NuxtLink
              to="https://via.glhf.vn/discord"
              target="_blank"
              class="transition-colors duration-100 ease-linear hover:text-[#5865f2]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
          ...
          <li>
            <NuxtLink
              ...
              target="_blank"
              class="transition-colors duration-100 ease-linear hover:text-[#161b22] dark:hover:text-[#f0f6fc]"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
